...
clearvars -except plant_in offset_input plant_out offset_output time time_all plant_in_all plant_out_all
aux_fig = 1;
...
plant_in_all = plant_in_all - offset_input;
plant_out_all = plant_out_all - offset_output;
...
interpolated_time_all = min(time_all):Ts:max(time_all);
